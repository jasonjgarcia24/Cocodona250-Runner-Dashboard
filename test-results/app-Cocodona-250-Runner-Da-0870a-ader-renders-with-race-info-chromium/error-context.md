...
- Name: app.spec.js >> Cocodona 250 Runner Dashboard >> header renders with race info
- Location: tests/e2e/app.spec.js:9:3
...
Locator: getByText('Cocodona')
Expected: visible
Error: strict mode violation: getByText('Cocodona') resolved to 2 elements:
    1) <span>Cocodona</span> aka getByText('Cocodona', { exact: true })
    2) <p class="text-sm">…</p> aka getByText('Cocodona 250 · May 4–9, 2026')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Cocodona')
